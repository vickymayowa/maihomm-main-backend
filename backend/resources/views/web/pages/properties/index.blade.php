        ...
        <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
            <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                    <h2 class="mb-0 text-heading fs-22 lh-15">All properties<span
                            class="badge badge-white badge-pill text-primary fs-18 font-weight-bold ml-2">{{ $properties->count() }}</span>
                    </h2>

                    <div class="mt-2 slideDiv">
                        <div data-tabs class="tabs col-12 pt-2">
                            @foreach ($statusOptions as $key => $value)
                                <a class="tab ml-2" href="{{ route('web.properties.index', ['status' => $key]) }}">
                                    <span
                                        class="tab_btn {{ $key == (request()->status ?? 'Available') ? 'active_properties_tab' : '' }}">{{ $value }}</label>
                                </a>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-6">
                        <div class="card shadow-hover-1">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top property_main_img"
                                data-url="{{ route('web.properties.show', $property->id) }}">
                            ...
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a
                                        href="{{ route('web.properties.show', $property->id) }}"
                                ...
                                <ul class="list-inline d-flex mb-0 flex-wrap">
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-2 "
                                        data-toggle="tooltip" title="{{ $property->bedrooms }} Br">
                                    ...
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-2"
                                        data-toggle="tooltip" title="{{ $property->bathrooms }} Ba">
                                    ...
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center px-1 mr-2"
                                        data-toggle="tooltip" title="{{ $property->sqft }} Sq.Ft">
                            ...
                            <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                                <div class="mr-auto">
                                    ...
                                    <span
                                        class="text-heading lh-15 font-weight-bold fs-15 ml-1">{{ format_money($property->per_slot, 2, $property->currency->short_name) }}</span>
                                </div>
                                <li class="list-inline-item">
                                    <a href="{{ route('web.properties.show', $property->id) }}" data-toggle="tooltip"
                                        title="View Details"
