                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pt-lg-0 pb-3">
                        <li class="breadcrumb-item fs-12 letter-spacing-087">
                            <a href="{{ route('dashboard.user.properties.index') }}">Properties</a>
                        </li>
                        <li class="breadcrumb-item fs-12 letter-spacing-087 active">Show</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <article class="col-lg-8 pr-xl-7">
                        <section class="pb-7 border-bottom">
                            ...
                            <div class="d-sm-flex justify-content-sm-between">
                                <div>
                                    ...
                                    <p class="mb-0"><i class="fal fa-map-marker-alt mr-2"></i>{{ $property->address }}
                                    </p>
                                </div>
                            ...
                            <div class="d-flex my-4">
                                ...
                                <div>
                                    ...
                                    <p class="px-3" style="margin-top: -7px;">
                                        {{ $property->projected_annual_yield_subtext }}
                                    </p>
                                </div>
                            </div>
                        ...
                        {{-- <section class="pb-7 border-bottom">
                            <h5 class="fs-20 text-heading lh-15 mb-5 pt-3 mt-4 px-0">Funding Timeline</h5>
                            <div class="px-1 pl-4">
                                        ...
                                        <div class="tab-content pt-4 pb-0 px-0 shadow-none">
                                            <div class="tab-pane fade show active" id="schedule" role="tabpanel">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <p>{{ $property->total_slots - $property->total_sold }}/{{ $property->total_slots }}
                                                            Available Slots</p>
                                                    </div>
                                                </div>
                                                ...
                                                @if ($property->isAvailable())
                                                    @php
                                                        $parameters = auth()
                                                            ->user()
                                                            ->isVerified()
                                                            ? ['property' => $property->id, 'redirect_url' => url()->current()]
                                                            : [$property->id];
                                                    @endphp
                                                    <a href="{{ route('dashboard.user.properties.payments.index', $parameters) }}"
                            ...
                            <div class="box">
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top property_main_img"
                                        data-url="{{ route('dashboard.user.properties.show', $category_property->id) }}">
                                            ...
                                            <ul class="list-inline mb-0 mt-auto hover-image">
                                                @if ($image_count > 0)
                                                    <li class="list-inline-item mr-2" data-toggle="tooltip"
                                                        ...
                                                        <a href="{{ route('dashboard.user.properties.show', $category_property->id) }}"
                                    ...
                                    <div class="card-body pt-3">
                                        <h2 class="card-title fs-16 lh-2 mb-0"><a
                                                href="{{ route('dashboard.user.properties.show', $category_property->id) }}"
                                    ...
                                    <div
                                        ...
                                        <ul class="list-inline mb-0">
                                            <form class="d-flex savedPropertyForm_{{ $category_property->id }}"
                                                action="{{ route('dashboard.user.saved-properties.store', $category_property->id) }}"
                                                method="post" data-action_type="add">
                                                @csrf
                                                <li>
                                                    <a id="{{ $category_property->id }}" data-toggle="tooltip"
                                                        title="Wish list"
                                                        class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center text-secondary bg-accent border-accent savedProperty"><i
                                                            class="fas fa-heart icon_{{ $category_property->id }}"
                                                            id="icon_{{ $category_property->id }}"></i></a>
                                                </li>
                    ...
                    <div class="slick-slider"
                        ...
                        @foreach ($close_by_properties as $close_by_property)
                            ...
                            <div class="box">
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top property_main_img"
                                        data-url="{{ route('dashboard.user.properties.show', $close_by_property->id) }}">
                                        <img src="{{ $close_by_property->getDefaultImage() }}" alt="Home in Metric Way">
                                        <div class="card-img-overlay p-2 d-flex flex-column">
                                            <div>
                                                <span
                                            ...
                                            <ul class="list-inline mb-0 mt-auto hover-image">
                                                @if ($image_count > 0)
                                                    <li class="list-inline-item mr-2" data-toggle="tooltip"
                                                        title="{{ $image_count }} Images">
                                                        <a href="{{ route('dashboard.user.properties.show', $close_by_property->id) }}"
                                                            class="text-white hover-primary">
                                                            <i class="far fa-images"></i><span
                                                                class="pl-1">{{ $image_count }}</span>
                                                        </a>
                                    ...
                                    <div class="card-body pt-3">
                                        <h2 class="card-title fs-16 lh-2 mb-0"><a
                                                href="{{ route('dashboard.user.properties.show', $close_by_property->id) }}"
                                    ...
                                    <div
                                        ...
                                        <ul class="list-inline mb-0">
                                            <form class="d-flex savedPropertyForm_{{ $close_by_property->id }}"
                                                action="{{ route('dashboard.user.saved-properties.store', $close_by_property->id) }}"
                                                method="post">
                                                @csrf
                                                <li>
                                                    <a id="{{ $close_by_property->id }}" data-toggle="tooltip"
                                                        title="Wish list"
                                                        ...
                                                        <i class="fas fa-heart icon_{{ $close_by_property->id }}"
                                                            id="icon_{{ $close_by_property->id }}"></i></a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="{{ route('dashboard.user.properties.show', $close_by_property->id) }}"
                                                        data-toggle="tooltip" title="View Details"
