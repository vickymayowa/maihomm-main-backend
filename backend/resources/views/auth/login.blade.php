...
@endsection
@section('content')
    <main class="d-md-flex justify-content-between bg-dark min-vh-100 align-items-center">
    <section id="login_bg" class=" rounded-right flex-fill w-100 text-dark view-point" style="background-color: #f5f7fb">
            <div class="py-10 px-10">
                ...
                <h2 class="text-light">Are my funds and asset safe at Maihomm?</h2>
                <p class="text-light">All clients funds and co-owned properties are held in Trust by Maihomm Trustees, a UK registered trust and regulated by the HMRC.</p>
            </div>
        </section>
        <section class="flex-fill w-lg-100 mx-10">
                <div >
                        <div class="card mb-6 bg-transparent border-0 text-light ">
                            <div class="card-body py-6">
                                <h2 class="card-title fs-30 font-weight-600 lh-16 mb-2">Login to your account</h2>
                                @include('notifications.flash_messages')
                                <form action="{{ route('login') }}" method="POST" class="form pb-3"> @csrf
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <a href="{{ route('password.request') }}"
                                            class="d-inline-block ml-auto fs-13 lh-2">
                                ...
                                <p> Don't have an account? <a href="{{ route('register') }}">Click to Sign
                                                up</a></p>
                                @endif
                            </div>
                        </div>
